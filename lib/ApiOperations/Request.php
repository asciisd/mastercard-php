...
use Mastercard\ApiRequestor;
use Mastercard\Exception\ApiErrorException;
use Mastercard\Exception\InvalidArgumentException;
use Mastercard\Util\RequestOptions;
...
trait Request
{
    ...
    protected static function _validateParams($params = null)
    {
        if ($params && !is_array($params)) {
            $message = "You must pass an array as the first argument to Mastercard API "
               . "method calls.  (HINT: an example call to create a charge "
               . "would be: \"Mastercard\\Charge::create(['amount' => 100, "
