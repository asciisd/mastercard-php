...
abstract class Util
{
    ...
    /**
     * Converts a response from the Mastercard API to the corresponding PHP object.
     *
     * @param array $resp The response from the Mastercard API.
     * @param array $opts
     * @return MastercardObject|array
     */
    public static function convertToMastercardObject($resp, $opts)
    {
        $types = [
            // business objects
        ...
        if (self::isList($resp)) {
            $mapped = [];
            foreach ($resp as $i) {
                array_push($mapped, self::convertToMastercardObject($i, $opts));
            }
            return $mapped;
        ...
        if (self::$isMbstringAvailable === null) {
            ...
            if (!self::$isMbstringAvailable) {
                trigger_error("It looks like the mbstring extension is not enabled. " .
                    ...
                    "support@mastercard.com if you have any questions.", E_USER_WARNING);
            }
        }
