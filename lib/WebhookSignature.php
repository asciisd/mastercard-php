...
abstract class WebhookSignature
{
    ...
    /**
     * Verifies the signature header sent by Mastercard. Throws an
     * Exception\SignatureVerificationException exception if the verification fails for
     * any reason.
     *
     * @param string $payload the payload sent by Mastercard.
     ...
     *
     * The current scheme used by Mastercard ("v1") is HMAC/SHA-256.
     *
